-- Existing Plain Depot dashboard connection schema.
-- This file is intentionally mapped to your current tables:
-- plain_depot_products, plain_depot_orders, plain_depot_shipments,
-- plain_depot_settings, plain_depot_state, plain_depot_suppliers.
--
-- It does NOT recreate your product/order/shipment tables.
-- It only creates the missing client profile table and public-safe storefront views.
